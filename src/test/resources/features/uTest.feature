...
Característica: : UTest Registro
  ...
  Escenario: Registrar usuario en UTest.com
    ...
    Entonces el verifica que se realizo el registro con la pantalla As a new tester, we recommend that you follow these 3 steps to begin getting involved with uTest:
