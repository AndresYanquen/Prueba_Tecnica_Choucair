...
public class CompleteData extends PageObject {
    ...
    public static final Target BUTTON_NEXTL =  Target.the("campo para email")
    ...
    public static final Target COUNTRY =  Target.the("campo para Pais")
    ...
    public static final Target MOBILE_DEVICE_ITEM =  Target.the("campo para item MAarca Movil")
